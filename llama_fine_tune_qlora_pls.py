...
INSTRUCTION = "Write a plain language summary for the article provided"
ARTICLE_KEY = "Input:"
...
def apply_prompt_template(examples):
  ...
  full_prompt = PROMPT_WITH_INPUT_FORMAT.format(summary=summary, article=article)
...
output_dir = "/llama2_7b_instruct_pls_gpt_summary_bz1_v2"
...
model_save_path = "/Volumes/llama2_feature_store/models/llama2_7b_instruct_pls_gpt_summary_bz1_v2"
...
prompt = """
### Instruction:
Write a plain language summary for the article provided

Input:
{article}

### Response: """.format(article=dataset['gpt_summary'][0])
